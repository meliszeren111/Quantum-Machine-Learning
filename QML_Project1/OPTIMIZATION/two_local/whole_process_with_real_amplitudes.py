...
ansatz1 = RealAmplitudes(num_qubits=raw_feature_map.num_qubits, reps=3, entanglement='linear').decompose()
ansatz2 = RealAmplitudes(num_qubits=zz_feature_map.num_qubits, reps=3, entanglement='linear').decompose()
