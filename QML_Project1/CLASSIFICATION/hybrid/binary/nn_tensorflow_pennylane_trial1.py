...
model = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(n_qubits, activation='linear'),
    quantum_layer1,
    tf.keras.layers.Dense(n_last_layer_nodes, activation='sigmoid')])
...
plt.show()
classical_rotation_angles = np.array([rotation_angle_for_1_st_qubit, rotation_angle_for_2_nd_qubit])                 # shape: (2,)
